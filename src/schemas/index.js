...
export const userSchemas = Yup.object({
    ...
    password: Yup.string().matches(passwordRegex,'Пароль должен содержать строчную букву (a-z), прописную букву (A-Z), цифру (0-9), специальный символ (!@#), длина пароля не менее 8 символов').required('Это поле обязательно для заполнения'),
